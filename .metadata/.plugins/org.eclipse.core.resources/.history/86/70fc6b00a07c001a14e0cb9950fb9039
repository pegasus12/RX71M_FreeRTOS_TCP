...
src/smc_gen/r_tfat_driver_rx/src/%.obj: ../src/smc_gen/r_tfat_driver_rx/src/%.c 
	...
	@echo src\smc_gen\r_tfat_driver_rx\src\cDepSubCommand.tmp=
	@sed -e "s/^/ /" "src\smc_gen\r_tfat_driver_rx\src\cDepSubCommand.tmp"
	ccrx -subcommand="src\smc_gen\r_tfat_driver_rx\src\cDepSubCommand.tmp" -output=dep="$(@:%.obj=%.d)"  -MT="$(@:%.d=%.obj)"  -MT="$(@:%.obj=%.d)" "$<"
	@echo src\smc_gen\r_tfat_driver_rx\src\cSubCommand.tmp=
	@sed -e "s/^/ /" "src\smc_gen\r_tfat_driver_rx\src\cSubCommand.tmp"
