...
src/smc_gen/r_usb_basic/src/hw/%.obj: ../src/smc_gen/r_usb_basic/src/hw/%.c 
	...
	@echo src\smc_gen\r_usb_basic\src\hw\cDepSubCommand.tmp=
	@sed -e "s/^/ /" "src\smc_gen\r_usb_basic\src\hw\cDepSubCommand.tmp"
	ccrx -subcommand="src\smc_gen\r_usb_basic\src\hw\cDepSubCommand.tmp" -output=dep="$(@:%.obj=%.d)"  -MT="$(@:%.d=%.obj)"  -MT="$(@:%.obj=%.d)" "$<"
	@echo src\smc_gen\r_usb_basic\src\hw\cSubCommand.tmp=
	@sed -e "s/^/ /" "src\smc_gen\r_usb_basic\src\hw\cSubCommand.tmp"
