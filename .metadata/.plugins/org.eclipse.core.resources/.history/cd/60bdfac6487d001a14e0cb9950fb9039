...
src/smc_gen/r_usb_hmsc/src/%.obj: ../src/smc_gen/r_usb_hmsc/src/%.c 
	...
	@echo src\smc_gen\r_usb_hmsc\src\cDepSubCommand.tmp=
	@sed -e "s/^/ /" "src\smc_gen\r_usb_hmsc\src\cDepSubCommand.tmp"
	ccrx -subcommand="src\smc_gen\r_usb_hmsc\src\cDepSubCommand.tmp" -output=dep="$(@:%.obj=%.d)"  -MT="$(@:%.d=%.obj)"  -MT="$(@:%.obj=%.d)" "$<"
	@echo src\smc_gen\r_usb_hmsc\src\cSubCommand.tmp=
	@sed -e "s/^/ /" "src\smc_gen\r_usb_hmsc\src\cSubCommand.tmp"
